...
print("dk", dk)
print("L", (k * 8.31)/1000)
paint_line_function(k, b, T_es, y_es=h_es, color_number=8, size=4, label="Нагревание")
...
print("dk", dk)
print("L", (k * 8.31)/1000)
paint_line_function(k, b, T_es, y_es=h_es, color_number=10, size=4, label="Охлаждение")
